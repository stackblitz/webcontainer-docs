...
Mounts a tree of files into the filesystem. This can be specified as a tree object (a [FileSystemTree](#filesystemtree))
...
a new WebContainer instance can be obtained by calling [`boot`](#▸-boot).
