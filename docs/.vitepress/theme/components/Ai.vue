    ...
    <div class="section">
      <div class="features-small">
        <div class="feature">
          ...
          <p>To ensure code generated by your LLM is valid, performant, and satisfies the prompt, you need to be able to actually execute it. WebContainers enable this securely, right inside the user’s browser tab.</p>
        </div>
        <div class="feature">
          <h2>Reduce security risks posed by virtual machines</h2>
